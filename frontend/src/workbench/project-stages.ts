export const PROJECT_STAGES = [
  ...
  { id: 'plan', label: '方案规划', view: 'plan', action: '查看方案与分工', empty: '需求明确后，在这里形成方案', description: '执行目标、实施方案和验收约定；按需要记录任务依赖。' },
  { id: 'build', label: '开发执行', view: 'execution', action: '查看执行现场', empty: '方案进入执行后，在这里跟踪开发', description: '持续编码、实际任务、尝试和修复记录。' },
