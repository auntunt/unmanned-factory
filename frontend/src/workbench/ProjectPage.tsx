...
type ProjectTab = 'overview' | 'agent' | 'settings'
...
export default function ProjectPage({ csrfToken, onUnauthorized }: PageProps) {
  ...
  useEffect(() => {
    if (!projectId) return
    const controller = new AbortController(); setProject(null); setRuns(null); setReadiness(null); setError(null); setRunsError(null); setReadinessError(null); setTab('overview')
