...
export default function RuntimePage({ csrfToken, onUnauthorized }: PageProps) {
  ...
  if (loading && !inspection) return <div className="wb-detail-page"><div className="wb-loading" role="status">正在读取运行配置与环境诊断…</div></div>
