...
function VerificationEvidence({ run }: { run: Run }) {
  ...
  const ledger = run.artifacts?.acceptance_ledger as { total?: number; counts?: { pass?: number; fail?: number; unverified?: number }; items?: Array<{ id: string; text: string; status: string; evidence: string }> } | undefined
