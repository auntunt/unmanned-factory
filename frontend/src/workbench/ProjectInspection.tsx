...
interface Inspection { history?: { run_id: string; at: string; verdict: 'pass' | 'fail' | 'unverified'; duration_s: number; failure_category?: string }[]; consecutive_failures?: number; enabled: boolean; interval_s: number; revision: number; last_at?: string; last_run_id?: string; last_status?: string; last_result?: string }
