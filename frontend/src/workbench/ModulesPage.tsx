...
export default function ModulesPage({ projectId, csrfToken, onUnauthorized, user, embedded = false }: PageProps & { projectId?: string | number; embedded?: boolean }) {
