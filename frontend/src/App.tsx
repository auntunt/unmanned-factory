...
import StartPage from './workbench/StartPage'
...
function RoutedWorkbench({ session, logout }: { session: AuthResponse; logout: () => void }) {
  ...
  return <Workbench user={session.user} onLogout={logout} {...pageProps}><Suspense fallback={<div className="wb-page"><div className="wb-card wb-loading-card"><span className="wb-spinner" aria-hidden="true" />正在打开页面…</div></div>}><Routes><Route index element={<StartPage {...pageProps} />} /><Route path="ability-center" element={<CapabilityCenter {...pageProps} />} /><Route path="modules" element={<LegacyCapabilityRedirect tab="modules" />} /><Route path="agents" element={<AgentsPage {...pageProps} />} /><Route path="agents/:agentId" element={<AgentsPage {...pageProps} />} /><Route path="overview" element={<OverviewPage {...pageProps} />} /><Route path="runs" element={<RunsPage {...pageProps} />} /><Route path="projects" element={<ProjectsPage {...pageProps} />} /><Route path="projects/:projectId" element={<ProjectPage {...pageProps} />} /><Route path="capabilities" element={<LegacyCapabilityRedirect tab="capabilities" />} /><Route path="costs" element={<CostsPage {...pageProps} />} /><Route path="team" element={<TeamPage {...pageProps} />} /><Route path="runs/:runId" element={<RunPage {...pageProps} />} />{isAdmin && <Route path="settings/runtime" element={<RuntimePage {...pageProps} />} />}<Route path="*" element={<Navigate to="/" replace />} /></Routes></Suspense></Workbench>
}
